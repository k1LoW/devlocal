...
tar xzvf zsh.tar.gz
cd zsh-5.0.5
./configure --prefix=$DEVLOCAL --enable-cflags="-I$DEVLOCAL/include" --enable-cppflags="-I$DEVLOCAL/include" --enable-ldflags="-L$DEVLOCAL/lib"  --enable-multibyte --enable-locale
make
make install
